...
"""
  ...
  private fun buildServers(): String {
    ...
    uniqueRepositories[mainDependency.mavenRepository.url] = buildServer(
        mainDependency.mavenRepository)

    this.controllerDependencies.controllerDependenciesList.forEach {
      uniqueRepositories[it.dependency.mavenRepository.url] = buildServer(
