...
class CPPJNIServerBuilder(private val location: String,
    ...
    override fun build(): Boolean {
        ...
        val javaHPath = Paths.get(javaServerJNIDirectory.toString(), "build", "classes", "main").toFile()
        ...
        projectInformation.controllers.controllerDependenciesList
                ...
                .forEach { controllerDependency ->
                    controllerDependency.controllers.controllersList.forEach { controller ->
                        ...
                        val report = FileProcessUtilities.executeProcess(javaHPath.toString(), "javah", fullName)
        ...
        val createReport = FileProcessUtilities.executeProcess(javaServerJNIDirectory.toString(), "mkdir", "-p $jniPath")
