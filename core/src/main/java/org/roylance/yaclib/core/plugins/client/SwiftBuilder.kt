...
class SwiftBuilder(private val location: String,
  ...
  override fun build(): Boolean {
    ...
    val addReport = SwiftUtilities.addFilesToProject(projectInformation.mainDependency, location,
        newFiles)
    ...
    if (processSwift) {
      ...
      val addFrameworksReport = SwiftUtilities.addFrameworksToProject(
          projectInformation.mainDependency, location)
