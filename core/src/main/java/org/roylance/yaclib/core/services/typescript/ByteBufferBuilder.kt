...
class ByteBufferBuilder: IBuilder<YaclibModel.File> {
    override fun build(): YaclibModel.File {
        val returnFile = YaclibModel.File.newBuilder()
                .setFileToWrite(ByteBufferDefinition.trim())
                .setFileExtension(YaclibModel.FileExtension.TS_EXT)
                .setFileName("bytebuffer.d")
    ...
    companion object {
        private const val ByteBufferDefinition = """// Type definitions for bytebuffer.js 5.0.0
...
// COPIED FOR YACLIB TO REDUCE DEPENDENCIES
